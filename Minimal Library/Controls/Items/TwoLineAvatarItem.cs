...
{
    /// <summary>
    /// Two line item with letter avatar
    /// </summary>
    public class TwoLineAvatarItem : MItem
    {
        /// <summary>
        /// Secondary text
        /// </summary>
        ...
        /// Constructor
        /// </summary>
        public TwoLineAvatarItem(string primaryText, string secondaryText)
        {
        ...
        public override void DrawItem(MListBox owner, Graphics g, Rectangle itemBounds)
        {
            ...
            // Avatar
            g.FillRectangle(new SolidBrush(owner.Tint), new Rectangle(new Point(Bounds.X + 10, Bounds.Y + (Bounds.Height / 2) - 16 - 1), new Size(32, 32)));
            ...
            g.DrawString(PrimaryText[0].ToString(), new Font("Segoe UI Light", 12), new SolidBrush(Color.White), new Rectangle(new Point(Bounds.X + 10, Bounds.Y + (Bounds.Height / 2) - 16 - 1), new Size(32, 32)), sfAvatar);
            ...
            g.DrawString(SecondaryText, new Font("Segoe UI", 8), new SolidBrush(textColor), new Rectangle(Bounds.X + 48, Bounds.Y + Bounds.Height / 2 - 9, Bounds.Width, Bounds.Height / 2 + 5), sfSecondary);
        }
    }
}
