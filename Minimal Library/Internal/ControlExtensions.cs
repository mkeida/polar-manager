...
{
    /// <summary>
    /// Internal class. Helps with bugged (bad written) WinForms controls
    /// </summary>
    internal static class ControlExtensions
    {
        ...
        {
            try { SendMessage(control.Handle, WM_SETREDRAW, true, 0); control.Refresh(); } catch { }
        }
        ...
        /// <summary>
        /// Cascade through all child controls of control at set Tint property
        /// </summary>
